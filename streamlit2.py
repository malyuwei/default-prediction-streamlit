...
#input features
early_return_amount =st.sidebar.slider("early return amount:",min_value=0, max_value=20000,step=1000)
...
def preprocess(early_return_amount, early_return_times):
...
user_input = preprocess(early_return_amount, early_return_times)
...
# prepare test set for shap explainability
    ...
    X = loans[['early_return_amount','early_return']]
    y = loans[['isDefault']]
